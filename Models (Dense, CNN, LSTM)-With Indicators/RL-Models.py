...
class CustomEnv:
    ...
    def __init__(self, df, df_normalized, initial_balance=1000, lookback_window_size=50, Render_range=100, Show_reward=False, Show_indicators=False, normalize_value=60000):
...
if __name__ == "__main__":            
    ...
    #train_agent(train_env, agent, visualize=False, train_episodes=300, training_batch_size=500)

    # multiprocessing training/testing. Note - run from cmd or terminal
    agent = CustomAgent(lookback_window_size=lookback_window_size, lr=0.00001, epochs=5, optimizer=Adam, batch_size=32, model="Dense", depth=depth, comment="Normalized")
    #train_multiprocessing(CustomEnv, agent, train_df, train_df_nomalized, num_worker = 32, training_batch_size=500, visualize=False, EPISODES=300)

    test_multiprocessing(CustomEnv, CustomAgent, test_df, test_df_nomalized, num_worker = 16, visualize=False, test_episodes=200, folder="2022_04_02_20_12_Crypto_trader", name="2212.94_Crypto_trader", comment="3 months")
